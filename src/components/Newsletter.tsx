  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about Hyphenbox data services soon."
      });
      setEmail("");
      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-700 mb-10 text-left">
            Stay updated on new data collection capabilities, hardware integrations, and research partnerships
          </p>
