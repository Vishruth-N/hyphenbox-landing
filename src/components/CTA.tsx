      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
            ...
            <span className="text-pulse-500">Robot Training?</span>
          </h2>
          
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Join leading robotics teams who trust Hyphenbox for high-quality training data. Get started with custom data collection today.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#get-access" className="button-primary group flex items-center justify-center w-full sm:w-auto">
              Get Custom Data
