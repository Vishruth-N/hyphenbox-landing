      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Professional data collection services designed specifically for robotics research teams.
          </p>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M12 8a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4 4 4 0 0 0 4-4v-8a4 4 0 0 0-4-4zm0 2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2z"></path><path d="M8.5 14H7a3 3 0 0 0 0 6h1.5"></path><path d="M15.5 14H17a3 3 0 0 1 0 6h-1.5"></path></svg>}
            title="Fast Turnaround"
            description="Get thousands of demonstrations in weeks, not months"
            index={0}
          />
          <FeatureCard
            ...
            description="We work with UMI, ALOHA, and custom setups"
            index={1}
          />
          <FeatureCard
            ...
            title="Quality First"
            description="Expert operators ensure consistent, high-quality data"
            index={2}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"></path></svg>}
            title="Custom Scenarios"
            description="Tailored data collection for your specific use cases"
            index={3}
          />
        </div>
      </div>
